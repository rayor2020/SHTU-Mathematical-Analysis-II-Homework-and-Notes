...
$$\raisebox{-0.5\height}{\includegraphics[height=3cm]{chapters/08/D-CC}}
...
Back to plane in $\mathbb{R}^3$: $ax+by+cz+d=0$\raisebox{-0.5\height}{\includegraphics[height=3cm]{chapters/08/axbyczd0}}
