...
Quadric surface: $\left\{\overrightarrow{x}\in\mathbb{R}^n\mid f\left(\overrightarrow{x}\right)=\overrightarrow{x}^TA\overrightarrow{x}+\overrightarrow{b}^T\overrightarrow{x}+c=1\right\},\,A=A^T$