...
\begin{define}[Directional Derivative 方向导数]
    ...
    \begin{enumerate}
        \item $\begin{aligned}
                      ...
                      dx_i|_x: & \begin{aligned}
                                     ...
                                     v            & \mapsto v_i
                                 \end{aligned} \\
                  \end{aligned}$, $\nabla x_i|_x=e_i$\quad\raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/09/02/0301}}\quad$\begin{aligned}
        ...
        \item $r=\sqrt{x^2+y^2},\theta=\arctan\frac{y}{x}$
              ...
              $\begin{aligned}
                  ...
                  \end{aligned}$\quad\raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/09/02/0302}}
    \end{enumerate}
\end{example}
