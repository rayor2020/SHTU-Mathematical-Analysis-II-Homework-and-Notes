...
\begin{thm}[Inverse Function Theorem]
    ...
    \begin{pf}
        Aim: For any $y$ near $y^0$, find $x$ s.t. $F(x)=y$\quad\raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/09/03/0301}}
    ...
    $\substack{(x,\varphi_z(x))\mapsfrom(x,z)\\(x^0,y^0)\mapsto(x^0,0)}$\quad\raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/09/03/0304}}
