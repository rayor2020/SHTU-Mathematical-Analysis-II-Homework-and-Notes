...
\begin{example}
    ...
    $$\raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/11/03/0201}}\quad\int_L xy\,\mathrm{d}x+x^2\,\mathrm{d}y=\int_{OA} xy\,\mathrm{d}x+x^2\,\mathrm{d}y+\int_{AB} xy\,\mathrm{d}x+x^2\,\mathrm{d}y+\int_{BO} xy\,\mathrm{d}x+x^2\,\mathrm{d}y$$
...
\begin{example}
    ...
    \begin{align*}
        \raisebox{-0.5\height}{\includegraphics[height=2cm]{chapters/11/03/0203}}\quad\int_{L_{AB}}\overrightarrow{F}\,\mathrm{d}\overrightarrow{r}
