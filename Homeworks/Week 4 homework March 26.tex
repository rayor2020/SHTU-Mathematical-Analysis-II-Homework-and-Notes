...
\begin{sol}
    ...
    所以当$t=\frac{2\pi}{3}$，$P(\frac{1}{2}, \frac{\sqrt{3}}{2})$

    计算$\frac{\partial z}{\partial x}=-\frac{y}{x^2+y^2}$, $\frac{\partial z}{\partial y}=\frac{x}{x^2+y^2}$

    $x^2+y^2=1$，所以$\nabla z|_P=(-\frac{\sqrt{3}}{2},\frac{1}{2})$

    圆法向量$\overrightarrow{n}=(x-1,y)$，所以切向向量$\overrightarrow{\tau}=(-y,x-1)=(-\frac{\sqrt{3}}{2},-\frac{1}{2})$

    所以方向微商$\frac{\partial z}{\partial\tau}=\nabla z\cdot\overrightarrow{\tau}=\frac{3}{4}-\frac{1}{4}=\frac{1}{2}$
\end{sol}
